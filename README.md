...
<p align="center"><img alt="OSPTEK 1.04 寸 340×340 AMOLED QSPI 模组（CO5300）宣传图" src="./images/product.png" width="640" /></p>
...
OSPTEK **1.04 寸 340×340 AMOLED** 是一款 **QSPI** 接口彩色显示模组，显示驱动为 **CO5300**，触摸驱动为 **CST820**。方形分辨率适合穿戴表盘、圆形 / 方形小屏 HMI 等场景。

规格标识（仓库名）：`1.04-amoled-340x340-qspi-co5300`

当前模组版本：**AM104Q340340LK**。电气与外形细节以 [`docs/AM_104_Q340340_LK_2_23736c9875.pdf`](./docs/AM_104_Q340340_LK_2_23736c9875.pdf) 为准。
...
| 资料 | 链接 |
| ---- | ---- |
| 产品规格书（AM104Q340340LK） | [`docs/AM_104_Q340340_LK_2_23736c9875.pdf`](./docs/AM_104_Q340340_LK_2_23736c9875.pdf) |
| 板对板连接器规格（OK-23GF024-04） | [`docs/OK-23GF024-04.pdf`](./docs/OK-23GF024-04.pdf) |
...
| 初始化序列（文本） | [`docs/BOE1.04_340x340_CO5300_QSPI_简码_202401021.txt`](./docs/BOE1.04_340x340_CO5300_QSPI_%E7%AE%80%E7%A0%81_202401021.txt) |
...
- 使用中如有问题，也可在本仓库 [Issues](https://github.com/osptek/1.04-amoled-340x340-qspi-co5300/issues) 中提问
